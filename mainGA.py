...
#    ax.set_title('axes title')
    ...
    ax.plot(serviceNumber['sfit'], label='minSOV')    
...
#    ax.set_title('axes title')
    ...
    ax.plot(nodeNumber['sfit'], label='minSOV')    
    #    plt.legend(loc="upper left") 
#upper, arriba    lower, abajo   center, centro    left, izquierda y    right, derecha
    plt.legend()
#    plt.show()
...
#    ax.set_title('axes title')
    ...
    ax.plot(networkDistance['sfit'], label='minSOV')    
    #    plt.legend(loc="upper left") 
#upper, arriba    lower, abajo   center, centro    left, izquierda y    right, derecha
    plt.legend()
#    plt.show()
    ...
    #    ax.set_title('axes title')
        ...
        ax.plot(reliability['sfit'], label='minSOV')      
        #    plt.legend(loc="upper left") 
    #upper, arriba    lower, abajo   center, centro    left, izquierda y    right, derecha
        plt.legend()
    #    plt.show()
...
#    ax.set_title('axes title')
    ...
    ax.plot(clusterbalanced['sfit'], label='minSOV')      
    #    plt.legend(loc="upper left") 
#upper, arriba    lower, abajo   center, centro    left, izquierda y    right, derecha
    plt.legend()
#    plt.show()
...
#    ax.set_title('axes title')
    ...
    ax.plot(thresholdDistance['sfit'], label='minSOV')     
    #    plt.legend(loc="upper left") 
#upper, arriba    lower, abajo   center, centro    left, izquierda y    right, derecha
    plt.legend()
#    plt.show()
...
#    ax.set_title('axes title')
    ax.set_xlabel('Generations', fontsize=14)
    ax.set_ylabel('SOV fitness', fontsize=14)
    plt.gcf().subplots_adjust(left=0.15)
